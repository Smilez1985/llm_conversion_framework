...
class ModuleCreationWizard(QWizard):
    ...
    def create_flags_page(self):
        ...
        # Stores the quantization logic generated by Ditto
    ...
    def update_summary(self):
        ...
        # Translate Yes/No manually or add to keys
        logic_status = "Yes" if self.quant_logic.toPlainText() else "No (Default)"
...
[LOGIC]
Quantization Script provided: {logic_status}
"""
    ...
    def _ai_worker(self, path):
        try:
            # Pass framework config to allow Ditto to access SSOT (Doku Links)
            # We need to access the parent window's framework manager
            fm_config = None
    ...
    def on_ai_finished(self, config):
        ...
        # Capture the critical build logic
