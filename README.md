...
1. Lade den neuesten [Installer (setup.exe)](Platzhalter-Link-zur-exe) und das zugehörige Zertifikat cert) herunter.
2. Führe erst das Cert-File und dann die Installation aus.
