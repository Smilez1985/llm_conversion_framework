...
class ModuleCreationWizard(QWizard):
    ...
    def create_intro_page(self):
        ...
        layout.addWidget(QLabel(
            ...
            "Please upload the 'target_hardware_config.txt' generated by hardware_probe.sh / .ps1."
        ))
        
        # --- Import Section ---
        import_group = QGroupBox("📂 Import Hardware Probe")
        import_layout = QVBoxLayout()
        
        hbox_btns = QHBoxLayout()
        
        # Button 1: Standard Import (Hardcoded Logic)
        self.btn_import_std = QPushButton("⚡ Standard Import (Rule-Based)")
        ...
        self.btn_import_ai = QPushButton("🤖 AI Auto-Discovery (Ditto)")
    ...
    def create_docker_page(self):
        ...
        self.rad_debian = QRadioButton("Debian 12 (Bookworm) - Recommended for CPU/NPU")
        self.rad_ubuntu = QRadioButton("Ubuntu 22.04 LTS - Recommended for CUDA")
        self.rad_custom = QRadioButton("Custom Base Image")
    ...
    def create_flags_page(self):
        ...
        layout.addRow("CPU Flags (GCC):", self.cpu_flags)
...
"""
    ...
    def run_standard_import(self):
        ...
        """
        path, _ = QFileDialog.getOpenFileName(self, "Select Hardware Probe", "", "Config (*.txt);;All Files (*)")
        if not path: return
        ...
        try:
            ...
            if config.get("SUPPORTS_NEON") == "ON": 
                ...
                # ARMv8 usually implies NEON, implicit in arch, but explicit doesn't hurt
            ...
            self.status_label.setText("✅ Standard Import successful!")
            ...
            QMessageBox.critical(self, "Import Error", f"Failed to parse probe file:\n{str(e)}")
    ...
    def run_ai_analysis(self):
        ...
        self.status_label.setText("🤖 Ditto is thinking...")
