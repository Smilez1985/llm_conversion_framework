...
IF DEFINED INSTALL_PATH (
    ...
    IF EXIST "%INSTALL_PATH%\orchestrator\main.py" (
        ...
        echo [WARN] Pfad ungueltig. Starte Setup...
    )
)
...
:: Dependencies für Installer
echo [SETUP] Lade Installer-Dependencies...
python -m pip install pywin32 winshell requests >nul 2>&1
